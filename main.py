...
#st
# Modified by Alan McNeil <a9k@a9k.info> to just run once a day
# does forecast, todo and fortune. Also does new fortune on short press.
#
...
# Invokes weather forecast, todos and fortune
def daily():
  GPIO.output(ledPin, GPIO.HIGH)
  subprocess.call(["python", "just_forecast.py"])
  subprocess.call(["python", "rtm_today.py"])
  subprocess.call(["python", "fortune.py"])
...
while(True):
  ...
  if dailyFlag == False:
	  ...
	  if (l.tm_hour == 0):	#reset at mindnight
